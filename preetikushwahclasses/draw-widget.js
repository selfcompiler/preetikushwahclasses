(function() {
  ...
  css.textContent = [
    ...
    '.dw-toolbar{display:flex;gap:3px;padding:5px 8px;background:#f9fafb;border-bottom:1px solid #e5e7eb;flex-shrink:0;align-items:center;overflow-x:auto;overflow-y:hidden;-webkit-overflow-scrolling:touch;scrollbar-width:none;}',
    '.dw-toolbar::-webkit-scrollbar{display:none;}',
